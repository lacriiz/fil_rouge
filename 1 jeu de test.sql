...
UPDATE [livraison] SET [com_numero]='7' WHERE [liv_numero]=1;
UPDATE [livraison] SET [com_numero]='6' WHERE [liv_numero]=2;
UPDATE [livraison] SET [com_numero]='5' WHERE [liv_numero]=3;
UPDATE [livraison] SET [com_numero]='9' WHERE [liv_numero]=6;
UPDATE [livraison] SET [com_numero]='11' WHERE [liv_numero]=7;
UPDATE [livraison] SET [com_numero]='3' WHERE [liv_numero]=9;
UPDATE [livraison] SET [com_numero]='8' WHERE [liv_numero]=10;
UPDATE [livraison] SET [com_numero]='10' WHERE [liv_numero]=13;
UPDATE [livraison] SET [com_numero]='15' WHERE [liv_numero]=15;
